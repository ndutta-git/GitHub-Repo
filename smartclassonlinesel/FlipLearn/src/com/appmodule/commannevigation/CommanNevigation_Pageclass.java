...
import com.appmodule.perform_pageclass.Assignment_PageClass;
import com.appmodule.perform_pageclass.Attendance_PageClass;
import com.appmodule.perform_pageclass.Dashboard_PageClass;
import com.appmodule.perform_pageclass.HealthStatus_PageClass;
...
/***********************************************All_Page_Header_logo***********************************************************************/
	...
	public static WebElement assignment_logo;;
...
/***************************************************************Share_Menu_Element************************************************/
	...
	@FindBy(xpath="//li[@class='first active topmenu' and contains(a, 'Attendance')]/a")
...
/********************************************Learn_Subject_Page_Logo*************************************************************/
    ...
    public static WebElement Art_txt_logo;
	
    @FindBy(xpath="//div[@class='breadcrumbs breadcrumb' and contains(h3, 'English')]")
    public static WebElement english_txt_logo;
    
    @FindBy(xpath="//div[@class='breadcrumbs breadcrumb sub_title' and contains(h3, 'Mathguru')]")
    public static WebElement Mathguru_txt_logo;
...
/************************************************Share_Menu_link***************************************************************/
    public static CommanNevigation_Pageclass mouseoveronsharelink(){
    ...
    public static Message_Pageclass clickonmessage() throws Exception, IOException{
    	...
    	Message_Pageclass messagepageobj=PageFactory.initElements(DriverObj, Message_Pageclass.class);
    	return messagepageobj;
    }
 /*************************************************perform_Menu_link**********************************************************/
    public static CommanNevigation_Pageclass mouseoveronperform(){
    	fn_MouseOver(DriverObj, perform_menu);
    	CommanNevigation_Pageclass commonobj=PageFactory.initElements(DriverObj, CommanNevigation_Pageclass.class);
        return commonobj;
    }
    ...
    public static Assignment_PageClass ClickonPerformAssignment() throws Exception, IOException{
    	Main_Manu_Item=fn_GetText(perform_menu);
    	Main_SubMainu_Item=fn_GetText(performassignment);
    	fn_mouseOverClick(DriverObj, perform_menu, performassignment);
    	Assignment_PageClass assignmentpageobj=PageFactory.initElements(DriverObj, Assignment_PageClass.class);
	...
	public static Marks_PageClass Clickonmarksreviewreportclasswise() throws Exception, IOException{
    	...
    	NavigationObj.mouseoveronperform();
    	Thread.sleep(2000);
