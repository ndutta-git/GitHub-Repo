...
public class Event_testscript extends Generic_class{
	...
	public static void verifyEvent() throws IOException{
		...
		{
			if(t.getAttribute("title").equalsIgnoreCase(Events_PageClass.Event_Title)){
				System.out.println(Events_PageClass.Event_Title+" successfully saved");
				flag=true;
				break;
			}
		}
